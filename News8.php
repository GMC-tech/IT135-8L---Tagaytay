    ...
    <div class="ne-container">
        <div class="ne-content">
		    ...
		    <p1>April 11, 2023</p1>
				...
				Color: Black<br>
				Breed: Mixed<br>
				Other Description: With blue checkered collar, thinning hair on the eyebrow.<br>
				Last Seen: Sitio Bayabas, Barangay San Isidro, Taytay, Rizal.
				For any information, please contacy 0926-166-8375</p>
            </div>
            </div>
        </div>
    </div>
