  ...
  <section class="ne-section">
    <div class="ne-container">
        <div class="ne-content">
            ...
            <div class="text">
                <h2>EARTH DAY 2023 READY!</h2>
		    <p1>April 20, 2023</p1>
                <p>FREE SEEDS | SEEDLINGS | FERTILIZERS <br>
...
This is brought to us by the Municipal Environment and Natural Resources Office MENRO Taytay,Rizal and the City Government of Taytay in the leadership of our Tobit Cruz and in cooperation with the Office of our Councilor Mayor Allan De Leon .
Limited stock. Until supplies last only.
Let's see each other!</p>
            </div>
            </div>
        </div>
    </div>
