     ...
     <div class="manage-content">
        ...
        <table>
            <tbody>
                ...
                <!-- POSTED -->
                <?php
                    $sql = "SELECT contents.content_id,contents.img,contents.title,category.category_name,contents.date_posted,contents.user_id,contents.category_id FROM contents LEFT JOIN category ON contents.category_id=category.category_id WHERE contents.category_id='2'";
